...
WebUI.click(findTestObject('Object Repository/sauceDemo/Page_Swag Labs/button_Open Menu'))

WebUI.click(findTestObject('Object Repository/sauceDemo/Page_Swag Labs/a_Logout'))
